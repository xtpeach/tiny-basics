...
function copyLog() {
    var copyContent = $("#logConsole").html();
    copyContent = copyContent.replace(/<br\s*\/?\s*>/ig, '\n');
    console.log("copyLog", copyContent);
    copyText(copyContent);
    layer.msg(I18n.joblog_rolling_log_copy + I18n.system_success);
}
