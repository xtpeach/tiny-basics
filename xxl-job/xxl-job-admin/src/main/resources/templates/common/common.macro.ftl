		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["XXL_JOB_LOGIN_IDENTITY"].role == 1>
                    ...
                    <li class="nav-click <#if pageName == "jobregistry">active</#if>" ><a href="${request.contextPath}/jobregistry"><i class="fa fa-circle-o text-gray"></i><span>${I18n.jobregistry_name}</span></a></li>
