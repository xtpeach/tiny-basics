	...
	<div class="content-wrapper">
	    ...
	    <section class="content">
	    	...
	    	<div class="row">
	              	...
	              	<div class="input-group">
                		...
                		<select class="form-control" id="jobGroup" >
                            <#if Request["XXL_JOB_LOGIN_IDENTITY"].role == 1>
                                <option value="-1" >${I18n.system_all}</option>  <#-- 仅管理员支持查询全部；普通用户仅支持查询有权限的 jobinfo -->
                            </#if>
                ...
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon">${I18n.jobinfo_opt_status}</span>
                ...
                <div class="col-xs-2">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="jobInfoId" placeholder="${I18n.jobinfo_field_id}" >
                    </div>
                </div>
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon">${I18n.jobinfo_field_jobdesc}</span>
                        <input type="text" class="form-control" id="jobDesc" placeholder="${I18n.jobinfo_field_jobdesc}" >
                    </div>
                </div>
<#--                <div class="col-xs-2">-->
<#--                    <div class="input-group">-->
<#--                        <span class="input-group-addon">JobHandler</span>-->
<#--                        <input type="text" class="form-control" id="executorHandler" placeholder="JobHandler" >-->
<#--                    </div>-->
<#--                </div>-->
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon">${I18n.jobinfo_field_author}</span>
                        <input type="text" class="form-control" id="author" placeholder="${I18n.jobinfo_field_author}" >
                    </div>
                </div>
	            <div class="col-xs-1">
