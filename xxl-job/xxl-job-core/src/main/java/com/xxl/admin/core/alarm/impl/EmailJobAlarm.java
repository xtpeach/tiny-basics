package com.xxl.admin.core.alarm.impl;

import com.xtpeach.tiny.basics.common.module.entity.xxl.job.XxlJobGroupEntity;
import com.xxl.admin.core.alarm.JobAlarm;
...
public class EmailJobAlarm implements JobAlarm {
    ...
    public boolean doAlarm(XxlJobInfoEntity info, XxlJobLogEntity jobLog){
        ...
        if (info!=null && info.getAlarmEmail()!=null && info.getAlarmEmail().trim().length()>0) {
            ...
            // email info
            XxlJobGroupEntity group = XxlJobAdminConfig.getAdminConfig().getXxlJobGroupDao().load(info.getJobGroup());
