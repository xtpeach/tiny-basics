...
public class JobScheduleHelper {
    ...
    private void refreshNextValidTime(XxlJobInfoEntity jobInfo, Date fromTime) throws Exception {
    ...
    // ---------------------- tools ----------------------
    public static Date generateNextValidTime(XxlJobInfoEntity jobInfo, Date fromTime) throws Exception {
